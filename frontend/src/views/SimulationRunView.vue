...
// Get maxRounds from query params at initialization time, ensuring child components can access it immediately
...
const handleGoBack = async () => {
  ...
  try {
    // First try graceful close of simulation environment
...
const loadGraph = async (graphId) => {
  // When simulating, auto-refresh doesn't show fullscreen loading to avoid flicker
