        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the report generation agent, can call 4 professional tools, with full MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph structure-based breadth-first traversal algorithm, reconstructing event propagation paths and capturing the topology of full information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface, optimized for indexing efficiency, used for rapid extraction of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview capability, conducting multi-round parallel dialogues with individuals in the simulated world, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to explore report content' : 'Chat with simulated individuals to understand their views' }}
              </p>
            </div>
            <div 
...
const renderMarkdown = (content) => {
  ...
  // Fix non-contiguous ordered list numbering: maintain incrementing numbers when single-item <ol> tags are separated by paragraph content
