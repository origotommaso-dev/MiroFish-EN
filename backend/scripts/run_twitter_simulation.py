...
This script reads parameters from the config file to execute simulation, fully automated
...
class TwitterSimulationRunner:
    ...
    def _create_model(self):
        ...
        Uses project root .env file config (highest priority):
        - LLM_API_KEY: API key
    ...
    def _get_active_agents_for_round(
        ...
        # Calculate activation probability based on each Agent config
        candidates = []
    ...
    async def run(self, max_rounds: int = None):
        ...
        print(f"  - Total simulation duration: {total_hours}h")
        print(f"  - Time per round: {minutes_per_round}min")
        ...
        if initial_posts:
            ...
            for post in initial_posts:
                ...
                try:
                    ...
                    print(f"  Warning: cannot create initial post for Agent {agent_id}create initial post: {e}")
...
async def main():
    ...
    # Initialize logging config (fixed filenames, clean old logs)
