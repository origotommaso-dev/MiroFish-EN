...
def get_report_sections(report_id: str):
    ...
    The frontend can poll this endpoint to get generated section content without waiting for the entire report.
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        # Only unlock interview after the report is completed
...
def get_agent_log(report_id: str):
    ...
    Retrieve real-time step-by-step actions during report generation, including:
...
def get_console_log(report_id: str):
    """
    Get console output log of the Report Agent

    Retrieve real-time console output (INFO, WARNING, etc.) during report generation.
