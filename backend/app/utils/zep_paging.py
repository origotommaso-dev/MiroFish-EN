...
Zep's node/edge listing API uses UUID cursor pagination.
This module wraps auto-pagination logic (with per-page retry),
transparently returning complete lists to the caller.
"""
...
def fetch_all_edges(
    ...
    """Fetch all graph edges with pagination, returning a complete list. Each page request has built-in retry."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
