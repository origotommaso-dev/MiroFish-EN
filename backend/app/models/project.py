...
Used to persist project state on the server side, avoiding the need for the frontend
to pass large amounts of data between API calls
"""
...
class Project:
    ...
    # Ontology information (populated after API endpoint 1 generates it)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph information (populated after API endpoint 2 completes)
...
class ProjectManager:
    ...
    def get_project(cls, project_id: str) -> Optional[Project]:
        ...
        Returns:
            Project object, or None if it doesn't exist
        """
