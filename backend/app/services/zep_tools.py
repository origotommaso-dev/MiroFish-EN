...
Wraps graph search, node reading, edge queries and other tools for Report Agent use

Core search tools (optimized):
1. InsightForge (deep insight search) - Most powerful hybrid search, auto-generates sub-queries with multi-dimensional search
2. PanoramaSearch (broad search) - Get full picture, including expired content
3. QuickSearch (simple search) - Fast search
"""
...
class InsightForgeResult:
    ...
    Contains search results for multiple sub-queries, along with comprehensive analysis
    """
    query: str
...
class InterviewResult:
    ...
    def to_text(self) -> str:
        """Convert to detailed text format for LLM comprehension and report citations"""
        text_parts = [
...
class ZepToolsService:
    ...
    [Core Search Tools - Optimized]
    1. insight_forge - Deep insight search (most powerful, auto-generates sub-queries, multi-dimensional search)
    2. panorama_search - Broad search (get full picture, including expired content)
    3. quick_search - Simple search (fast search)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all graph edges (with pagination, including temporal info)
    ...
    def get_entity_summary(
        ...
        Search for all info related to this entity and generate a summary
    ...
    def get_simulation_context(
        ...
        Comprehensively search for all info related to simulation requirements
    ...
    def insight_forge(
        ...
        Most powerful hybrid search function, auto-decomposes questions with multi-dimensional search:
        1. Uses LLM to decompose question into multiple sub-questions
        ...
        5. Integrates all results, generates deep insights
        ...
        Args:
            ...
            max_sub_queries: Maximum sub-query count
            
        Returns:
            InsightForgeResult: Deep insight search result
        """
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        Get full picture view, including all relevant content and historical/expired info:
        1. Get all relevant nodes
        2. Get all edges (including expired/invalidated)
        3. Classify and organize current and historical info
    ...
    def quick_search(
        ...
        3. Suitable for simple, direct search needs
    ...
    def interview_agents(
        ...
        4. Calls /api/simulation/interview/batch for real interviews (dual-platform simultaneously)
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Clean possible JSON tool call wrappers
                ...
                # Strategy 2 (supplementary): Long text within properly paired CJK quotation marks
                if not key_quotes:
...
Please select at most {max_agents} Agents most suitable for interview, and explain the selection reasoning."""
...
5. Keep each question concise and clear, under 50 words
...
- Use quotation marks when citing interviewees' original words
