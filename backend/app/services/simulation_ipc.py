...
2. Simulation script polls the commands directory, executes commands and writes responses to the responses/ directory
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview both platforms in dual-platform simulation, or the active platform in single-platform simulation
            timeout: Timeout in seconds
