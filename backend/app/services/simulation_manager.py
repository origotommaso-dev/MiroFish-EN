...
class SimulationState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Complete state dictionary (internal use)"""
        return {
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if progress_callback:
                progress_callback(
                    "reading", 100, 
                    f"Complete, {filtered.filtered_count} entities total",
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No qualifying entities found, please check if the graph was built correctly"
                self._save_simulation_state(state)
                return state
            ...
            # Set up realtime save file path (prefer Reddit JSON format)
