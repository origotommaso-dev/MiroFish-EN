...
- We need to simulate the reactions of various parties in public opinion events and the information propagation paths
...
**Quantity requirement: Exactly 10 entity types required**
...
- Various people will appear in the text, such as "elementary school teachers", "bystanders", "anonymous netizens"
...
- Person: Any individual person (used when not fitting the above specific types)
...
- Organization: Any organization/institution (used when not fitting the above specific types)
...
class OntologyGenerator:
    ...
    def _build_user_message(
        ...
        if len(combined_text) > self.MAX_TEXT_LENGTH_FOR_LLM:
            ...
            combined_text += f"\n\n...(Original text has {original_length} characters total. The first {self.MAX_TEXT_LENGTH_FOR_LLM} characters have been extracted for ontology analysis)..."
...
4. All entity types must be real-world subjects that can speak out; they cannot be abstract concepts
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if fallbacks_to_add:
            ...
            if current_count + needed_slots > MAX_ENTITY_TYPES:
                ...
                # Remove from the end (preserve the more important specific types at the beginning)
