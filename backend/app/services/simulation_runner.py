...
class SimulationRunState:
    ...
    # Independent rounds and simulated time per platform (for dual-platform parallel display)
...
class SimulationRunner:
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If two platforms were run, both need to be completed
                                ...
                                # Update round info (from round_end event)
                                    ...
                                    # Update independent rounds and time per platform
                                    if platform == "twitter":
    ...
    def _terminate_process(cls, process: subprocess.Popen, simulation_id: str, timeout: int = 10):
        ...
        Args:
            ...
            timeout: Timeout for waiting process exit (seconds)
        """
        if IS_WINDOWS:
    ...
    def _read_actions_from_file(
        ...
        Args:
            ...
            default_platform: Default platform (used when action records lack platform field)
    ...
    def get_all_actions(
        ...
        """
        Get complete action history from all platforms (no pagination limit)
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        """
        Clean up simulation run logs (for forcing a simulation restart)
    ...
    def cleanup_all_simulations(cls):
        ...
        Called when server shuts down, ensures all child processes are terminated
        """
    ...
    def register_cleanup(cls):
        ...
        Called when Flask app starts, ensures all simulation processes are cleaned up when server shuts down
        """
        ...
        # If not in debug mode, this env var is absent, and registration is still needed
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview both platforms in dual-platform simulation, return integrated results
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: Interview both platforms for each Agent in dual-platform simulation
            timeout: Timeout in seconds
    ...
    def close_simulation_env(
        ...
        Send close environment command to the simulation, allowing it to gracefully exit wait-for-command mode
    ...
    def get_interview_history(
        ...
        if platform in ("reddit", "twitter"):
            ...
            # When no platform specified, query both
